...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 4), // void *()(size_t)
/*  1 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 28), // size_t
/*  2 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  3 */ _CFFI_OP(_CFFI_OP_FUNCTION, 6), // void()(void *)
/*  4 */ _CFFI_OP(_CFFI_OP_POINTER, 6), // void *
...
static const struct _cffi_global_s _cffi_globals[] = {
  ...
  { "malloc", (void *)_cffi_f_malloc, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_O, 0), (void *)_cffi_d_malloc },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__pypy_util_cffi_inner(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__pypy_util_cffi_inner(void) { return NULL; }
#  else
     init_pypy_util_cffi_inner(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit__pypy_util_cffi_inner(void)
{
  return _cffi_init("_pypy_util_cffi_inner", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_pypy_util_cffi_inner(void)
{
  _cffi_init("_pypy_util_cffi_inner", 0x2601, &_cffi_type_context);
}
#endif
